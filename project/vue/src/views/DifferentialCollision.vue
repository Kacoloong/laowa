    ...
    setup() {
        ...
        const analyze = async () => {
            ...
            try {
                ...
                const response = await axios.post('http://127.0.0.1:5000/api/hash_function/diff-collision', {
                    method: 'POST',
                ...
                const realDate = response.data;
                const data = realDate.data;
                ...
                // 格式化返回结果
                renderedResult.value = `
                    <p><strong>状态:</strong> ${realDate.msg}</p>
        ...
        const generateChart = () => {
            ...
            pdfSrc.value = `http://127.0.0.1:5000/api/hash_function/get-diff-collision-pdf?filePath=${encodeURIComponent(pdfFilePath.value)}`;
            console.log("PDF Src set to:", pdfSrc.value);
        };
        // const cancelAnalysis = async () => {
        //     try {
        //         const response = await axios.post('http://127.0.0.1:5000/api/hash_function/diff-collision/cancel', {
